...
const Cart = ({ cartItems, setCartItems }) => {
  ...
  const handleIncreaseQuantity = async (userId, itemId) => {
    try {
      const updateUrl = `https://green-grocer-app.onrender.com/api/update-cart-quantity/${userId}/${itemId}`;
  ...
  const handleDeleteItem = async (userId, itemId) => {
    try {
      const deleteUrl = `https://green-grocer-app.onrender.com/api/delete-from-cart/${userId}/${itemId}`;
  ...
  const initPayment = (data) => {
    const options = {
      ...
      handler: async (response) => {
        try {
          const verifyUrl = "https://green-grocer-app.onrender.com/api/payment/verify";
  ...
  const handlePayment = async () => {
    try {
      const orderUrl = "https://green-grocer-app.onrender.com/api/payment/orders";
